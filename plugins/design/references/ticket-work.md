...
Convert design artifacts into backlog-ready Jira tickets. The ticket describes
the desired product outcome. Design artifacts show what it looks like. The team
decides implementation, breakdown, assignment, and testing approach.

## Gather Design Artifacts

Collect whatever exists before drafting:

- `.design/README.md` and `.design/changelog/`
- Prototype files or links
- Figma files or screenshots
- Design story or scope artifacts
- Existing Jira ticket text, if any
- User-provided notes or Slack context

Capture design coverage gaps:
...
Keep design system specifics; remove implementation prescriptions.

| Keep | Remove |
|---|---|
| Use the success color token | Add `text-green-600` |
| Use the Accordion component | Implement CSS grid rows |
| Collapsible with smooth animation | Use a specific hook name |
...
Recordings means user-authored async demos or walkthroughs, not call or meeting
recordings.
